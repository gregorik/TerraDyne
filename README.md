...
Place BP_TerraDyneManager (from Content/TerraDyne/Blueprints/) at 0, 0, 0.

Place TerraDyneOrchestrator (C++ Actor) at 0, 0, 3000.
...
Place BP_TerraDyneManager in the level.

Select the Manager.

In the Details Panel, find TerraDyne | Tools.

Set Auto Import At Runtime to True (simplest method).
